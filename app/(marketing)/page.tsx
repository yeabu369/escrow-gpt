      ...
      <section className="container grid justify-center gap-6 py-8 md:py-12 lg:py-24">
        ...
        {stars && (
          <Link
            ...
            className="flex"
          >
            <div className="flex items-center justify-center w-10 h-10 space-x-2 border rounded-md border-slate-600 bg-slate-800">
              <svg
            ...
            <div className="flex items-center">
              <div className="w-4 h-4 border-l-0 border-r-8 border-solid border-y-8 border-y-transparent border-r-slate-800"></div>
              <div className="flex items-center h-10 px-4 font-medium border rounded-md border-slate-800 bg-slate-800 text-slate-200">
